...
\fancypagestyle{plain}{
  ...
  \fancyhead[R]{\footnotesize{Presentació}}
...
%\input{chapters/1_fotovoltaica}
%\input{chapters/2_electronica}
%\input{chapters/3_web}

%\input{chapters/Conclusio}


\appendix

%\input{chapters/A.calculs}

\end{spacing}
\begin{spacing}{1}

%\input{chapters/B.programa}
